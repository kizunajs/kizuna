// Generated by @kizunajs/swift. Do not edit by hand.
...
public struct APIWorkspaceClient: Sendable {
    ...
    public func getWorkspace() async throws(APIClient.WorkspaceGetWorkspace.Failure) -> APIClient.WorkspaceGetWorkspace.Result {
        ...
        case 401:
            let payload = try Kizuna.decode(API.GuardDenial.self, from: data, using: client.decoder, statusCode: statusCode, failure: APIClient.WorkspaceGetWorkspace.Failure.self)
    ...
    public func deleteWorkspace() async throws(APIClient.WorkspaceDeleteWorkspace.Failure) -> APIClient.WorkspaceDeleteWorkspace.Result {
        ...
        case 401:
            let payload = try Kizuna.decode(API.GuardDenial.self, from: data, using: client.decoder, statusCode: statusCode, failure: APIClient.WorkspaceDeleteWorkspace.Failure.self)
    ...
    public func transfer(_ body: APIClient.WorkspaceTransfer.Body) async throws(APIClient.WorkspaceTransfer.Failure) -> APIClient.WorkspaceTransfer.Result {
        ...
        case 401:
            let payload = try Kizuna.decode(API.GuardDenial.self, from: data, using: client.decoder, statusCode: statusCode, failure: APIClient.WorkspaceTransfer.Failure.self)

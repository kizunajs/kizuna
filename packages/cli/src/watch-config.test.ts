...
/**
 * `ApiDefinition['routes']` is a tree, so a group reads as `Routes | RouteDefinition`.
 * The fixture knows its own shape.
 */
const routePath = (contract: ApiDefinition | undefined, group: string, route: string): string | undefined => {

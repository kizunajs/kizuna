    ...
    return {
        processRoute({ routeKey, route, deprecated, deprecationMessage }) {
            if (routeStreams(route) && soleStreamResponse(route) === undefined) {
                console.warn(`[kizuna/swift] Skipping route "${routeKey}": a streamed status beside another 2xx status is not generated.`);
                return;
            }
...
export const generateSwiftClient = (api: ApiDefinition, options: SwiftConfig): string => {
    ...
    writer.line('// Generated by @kizunajs/swift. Do not edit by hand.');
    writer.blank();
    ...
    for (const warning of registry.warnings()) {
        process.stderr.write(`[kizuna/swift] AnyCodable fallback at ${warning}\n`);
    }

    ...
    return {
        processRoute({ routeKey, route, deprecated, deprecationMessage }) {
            if (routeStreams(route) && soleStreamResponse(route) === undefined) {
                console.warn(`[kizuna/kotlin] Skipping route "${routeKey}": a streamed status beside another 2xx status is not generated.`);
                return;
            }
...
export const generateKotlinClient = (api: ApiDefinition, config: KotlinConfig): string => {
    ...
    writer.line('// Generated by @kizunajs/kotlin. Do not edit by hand.');
    writer.blank();
    ...
    for (const warning of registry.warnings()) {
        process.stderr.write(`[kizuna/kotlin] JsonElement fallback at ${warning}\n`);
    }

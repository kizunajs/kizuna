    ...
    return (
        <div className={styles.about}>
            ...
            <p className={styles.body}>
                I built Kizuna for the products and projects our team ships. Every change to the API meant editing the same shapes in
            ...
            <p className={styles.body}>
                ...
                solved the TypeScript half properly. Routes first, declared once, typed on both sides. The research and most of the syntax
                started there, which is why if you know ts-rest you already know most of Kizuna.
            </p>
            <p className={styles.body}>
                It stopped at the edge of TypeScript. That is the part Kizuna adds: Swift and Kotlin clients generated from the same routes,
                where an endpoint deprecated once in TypeScript arrives as <code className={styles.code}>@available</code> in Xcode and{' '}
                <code className={styles.code}>@Deprecated</code> in Android Studio.
            </p>
            <p className={styles.body}>

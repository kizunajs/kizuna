...
The [access control map](/docs/access-control) names what a route requires, as for any identity:
...
- [Access Control](/docs/access-control) for the access control map

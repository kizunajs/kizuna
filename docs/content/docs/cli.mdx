...
`@ts-kizuna/cli` is the `kizuna` command. It reads your [config](/docs/config) and answers three questions: what should be generated, what does this API serve, and what did this change cost a caller.

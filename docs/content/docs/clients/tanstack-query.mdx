...
export const apiClient = new KizunaClient(apiContract, {
    baseUrl: 'http://localhost:3000',
});

export const api = new KizunaTanstackQuery(apiContract, apiClient);
```

`apiContract` is what the generated client exports. See [Fetch client](/docs/clients/fetch) for generating it.

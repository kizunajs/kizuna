---
title: Kotlin
description: Generate a native Kotlin client from your routes with the ts-kizuna-kotlin CLI.
---
...
| Flag                  | Description                                                                                         |
| --------------------- | --------------------------------------------------------------------------------------------------- |
| `--config`            | Path to your `kizuna.config.ts`. Suffix it with an export to read something other than the default  |
...
The CLI loads the config at runtime.

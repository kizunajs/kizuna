...
Tools are new. How a route publishes, how a call runs, and how a client reads one will likely change before v2, so pin your version if you depend on it.
...
import { buildToolDefinitions } from '@ts-kizuna/mcp';

...
`@kizunajs/mcp` adds an [MCP (Model Context Protocol)](https://modelcontextprotocol.io) endpoint to your API. Every route that declares [`tool`](/docs/tools) is one an AI assistant can discover and call.

<InstallTabs packageName="@kizunajs/mcp" />

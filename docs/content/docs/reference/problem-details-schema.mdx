...
A route the [auth map](/docs/authentication) guards gets `401` and `403` as Problem Details. See [the 401 and 403 on every guarded route](/docs/authentication#the-401-and-403-on-every-guarded-route).

...
description: Build TanStack Query options from a Kizuna fetch client.
---
...
<InstallTabs packageName="@kizunajs/tanstack-query" />
...
| --------- | -------- | ------------------------------------------------------------------------ |
| `client`  | `Client` | A [fetch client](/docs/clients/fetch), from the generated `createClient` |

...
| `requestContext` | `ContextHeaderInputs`                | \*       | Header values for the contract's [request context](/docs/reference/k-request-context). Present only when the contract declares one, and required when any of its headers is |

...
These are [plugin routes](/docs/plugins#plugin-routes): they live outside `api.routes`, so your fetch client, the generated Swift and Kotlin clients, and the document itself never list them.

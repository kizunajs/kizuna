...
`createGenerator` from `@ts-kizuna/core/generator` lets you walk your api and produce any output, such as a typed client for another language, documentation, or a route manifest.
